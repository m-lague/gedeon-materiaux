...
ActiveRecord::Schema[7.0].define(version: 2024_04_16_100124) do
  ...
  create_table "construction_systems", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.text "features", default: "liste des caractéristiques", null: false
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["material_id"], name: "index_ratings_on_material_id"
    t.index ["user_id", "material_id"], name: "index_ratings_on_user_id_and_material_id", unique: true
